...
vertsActor.GetProperty().SetPointSize(15.0)
#---------------------------------------
...
glyphBdyActor = vtk.vtkActor()
glyphBdyActor.SetMapper(glyphMapper)
glyphBdyActor.GetProperty().SetRepresentationToWireframe()
glyphBdyActor.GetProperty().SetColor(1.,1.,1.)
glyphBdyActor.GetProperty().SetAmbient(1.)
